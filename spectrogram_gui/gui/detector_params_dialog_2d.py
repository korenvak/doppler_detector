...
class Detector2DParamsDialog(QDialog):
    """Parameter dialog for the 2D peak detector."""

    def __init__(self, parent=None, detector=None):
        super().__init__(parent)
        self.setWindowTitle("2D Detection Parameters")
        ...
        self.power_thresh_spin.setRange(0.01, 1.0)
        ...
        self.peak_prom_spin.setRange(0.001, 1.0)
        ...
        self.min_avg_power_spin.setRange(0.01, 1.0)
        ...
        self.merge_freq_spin.setRange(0.1, 1000.0)
        self.merge_freq_spin.setSingleStep(1.0)
        self.merge_freq_spin.setValue(detector.merge_max_freq_diff_hz)
        layout.addRow("Merge Max Freq Diff [Hz]:", self.merge_freq_spin)
    ...
    def accept(self):
        ...
        d.merge_max_freq_diff_hz = self.merge_freq_spin.value()
        super().accept()
