...
# Movement type colors for pixel-relative analysis
movement_colors = {
    'approaching': '#2ECC71',    # green
    'departing': '#E74C3C',     # red
    'hovering': '#9B59B6',      # purple
    'accelerating': '#F1C40F',  # yellow
    'decelerating': '#3498DB',  # blue
    'turning': '#E67E22',       # orange
...
def update_map_controls(flight, selection):
    ...
    legend_items = [
        ...
        for mt, col in movement_colors.items()
    ]

    legend = html.Div([
        html.Small("Movement Types:"),
        html.Ul(legend_items, style={'listStyle': 'none', 'paddingLeft': '0', 'margin': '0'})
    ], className="ms-2")

    return html.Div([alert, legend])
    ...
    if view_mode == 'individual':
        ...
        for px in pixels:
            ...
            for window_idx, (coords, meta, snapshot) in enumerate(windows):
                ...
                mov_col = movement_colors.get(m.get('pixel_movement_type', 'cruising'), '#95A5A6')
